...
namespace ServiceConversor
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://www.dataaccess.com/webservicesserver/", ConfigurationName="ServiceConversor.NumberConversionSoapType")]
    public interface NumberConversionSoapType
    {
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<ServiceConversor.NumberToWordsResponse> NumberToWordsAsync(ServiceConversor.NumberToWordsRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<ServiceConversor.NumberToDollarsResponse> NumberToDollarsAsync(ServiceConversor.NumberToDollarsRequest request);
    }
    ...
    public partial class NumberToWordsRequest
    {
        ...
        public ServiceConversor.NumberToWordsRequestBody Body;
        
        public NumberToWordsRequest()
        {
        }
        
        public NumberToWordsRequest(ServiceConversor.NumberToWordsRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class NumberToWordsResponse
    {
        ...
        public ServiceConversor.NumberToWordsResponseBody Body;
        
        public NumberToWordsResponse()
        {
        }
        
        public NumberToWordsResponse(ServiceConversor.NumberToWordsResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class NumberToDollarsRequest
    {
        ...
        public ServiceConversor.NumberToDollarsRequestBody Body;
        
        public NumberToDollarsRequest()
        {
        }
        
        public NumberToDollarsRequest(ServiceConversor.NumberToDollarsRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class NumberToDollarsResponse
    {
        ...
        public ServiceConversor.NumberToDollarsResponseBody Body;
        
        public NumberToDollarsResponse()
        {
        }
        
        public NumberToDollarsResponse(ServiceConversor.NumberToDollarsResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public interface NumberConversionSoapTypeChannel : ServiceConversor.NumberConversionSoapType, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public partial class NumberConversionSoapTypeClient : System.ServiceModel.ClientBase<ServiceConversor.NumberConversionSoapType>, ServiceConversor.NumberConversionSoapType
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<ServiceConversor.NumberToWordsResponse> ServiceConversor.NumberConversionSoapType.NumberToWordsAsync(ServiceConversor.NumberToWordsRequest request)
        {
            return base.Channel.NumberToWordsAsync(request);
        }
        
        public System.Threading.Tasks.Task<ServiceConversor.NumberToWordsResponse> NumberToWordsAsync(ulong ubiNum)
        {
            ServiceConversor.NumberToWordsRequest inValue = new ServiceConversor.NumberToWordsRequest();
            inValue.Body = new ServiceConversor.NumberToWordsRequestBody();
            inValue.Body.ubiNum = ubiNum;
            return ((ServiceConversor.NumberConversionSoapType)(this)).NumberToWordsAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<ServiceConversor.NumberToDollarsResponse> ServiceConversor.NumberConversionSoapType.NumberToDollarsAsync(ServiceConversor.NumberToDollarsRequest request)
        {
            return base.Channel.NumberToDollarsAsync(request);
        }
        
        public System.Threading.Tasks.Task<ServiceConversor.NumberToDollarsResponse> NumberToDollarsAsync(decimal dNum)
        {
            ServiceConversor.NumberToDollarsRequest inValue = new ServiceConversor.NumberToDollarsRequest();
            inValue.Body = new ServiceConversor.NumberToDollarsRequestBody();
            inValue.Body.dNum = dNum;
            return ((ServiceConversor.NumberConversionSoapType)(this)).NumberToDollarsAsync(inValue);
        }
